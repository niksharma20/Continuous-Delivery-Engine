...
Goal: Build, Show and Experinec integration between OCP, Ansible, EDA. user can take home this setup and explore different use cases. You'll walk away with a working, end-to-end delivery pattern you can adapt to your own heterogeneous environment.
